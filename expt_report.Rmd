...
df <- read.table(
file = "SSF-12509_miseq_v1.metrics_p5.1",
sep="\t",
header=T,
...
## Sample representation for ``r params$ssf``
...
## H3K27ac FRiP stratification (samples only) for ``r params$ssf``
...
## Evaluation of total reads for ``r params$ssf``
